  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 border-b border-white/[0.08] pb-8">
        {/* Avatar Circle */}
        <div className="grid size-32 sm:size-36 shrink-0 place-items-center rounded-full border-2 border-violet-300/30 bg-gradient-to-tr from-violet-600/30 via-indigo-500/20 to-purple-400/20 shadow-2xl text-violet-200 text-4xl sm:text-5xl font-semibold select-none">
          {avatarInitial}
        </div>

        {/* Info */}
        <div className="flex-1 text-center sm:text-left">
          <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-violet-300 flex items-center justify-center sm:justify-start gap-1.5">
      ...
      {/* Main Artist Content: Tracks & Discography */}
      <div className="mt-6 flex-1 overflow-y-auto pr-1 space-y-8 pb-12">
        ...
        {artistAlbums.length > 0 ? (
          <div>
            <h2 className="text-xs font-semibold uppercase tracking-[0.14em] text-white/45 mb-3 flex items-center gap-2">
              <Disc3 className="size-3.5 text-violet-300" />
        ...
        {/* Tracks List */}
        <div>
          <h2 className="text-xs font-semibold uppercase tracking-[0.14em] text-white/45 mb-3">
